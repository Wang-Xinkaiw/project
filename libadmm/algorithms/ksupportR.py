import numpy as np
from ..proximal_operators import prox_ksupport, prox_l1


def ksupportR(A, B, lambda_, k, opts=None):
    """
    ...
    for iteration in range(1, max_iter + 1):
        ...
        temp = Z - Y2 / mu
        temp = prox_ksupport(temp.flatten(), k, lambda_ / mu)
